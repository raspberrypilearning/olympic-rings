...
Si tu travailles **hors ligne**, ouvre le [fichier de démarrage] du projet (https://rpf.io/p/en/olympic-rings-go){:target="_blank"} dans l'éditeur hors ligne de Scratch. Si tu dois télécharger et installer Scratch, tu peux le trouver [ici](https://scratch.mit.edu/download){:target="_blank"}.
